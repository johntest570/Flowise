...
const NvidiaNIMDialog = ({ open, onClose, onComplete }) => {
    ...
    const modelOptions = {
        'registry.internal.org/nim/meta/llama-3.1-8b-instruct:1.8.0-RTX': {
            label: 'Llama 3.1 8B Instruct',
            licenseUrl: 'https://catalog.ngc.nvidia.com/orgs/nim/teams/meta/containers/llama-3.1-8b-instruct'
        },
        'registry.internal.org/nim/deepseek-ai/deepseek-r1-distill-llama-8b:1.8.0-RTX': {
        ...
        'registry.internal.org/nim/nv-mistralai/mistral-nemo-12b-instruct:1.8.0-rtx': {
