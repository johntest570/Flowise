...
router.use('/internal-chatmessage', IdentityManager.checkFeatureByPlan('feat:internal'), internalChatmessagesRouter)
router.use('/internal-prediction', IdentityManager.checkFeatureByPlan('feat:internal'), internalPredictionRouter)
...
router.use('/mcp-server', IdentityManager.checkFeatureByPlan('feat:mcp'), mcpServerRouter)
router.use('/mcp', IdentityManager.checkFeatureByPlan('feat:mcp'), mcpEndpointRouter)
